        ...
        con.connect(function(err) {
            ...
            con.query(sql, function (err, result) {
                ...
                if(!result.length){ // si la table n'est pas présente alors on la crée
                    let createTablesql = "CREATE TABLE `scores` (`id` int(11) NOT NULL AUTO_INCREMENT,`pseudo` tinytext NOT NULL,`pieces` tinyint(4) NOT NULL,`chrono` time NOT NULL,`partie` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=latin1"
